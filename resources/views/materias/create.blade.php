    ...
    <form action="{{ route('materias.store') }}" method="POST">
        ...
        <div class="row">
                ...
                <select name="id_estudiantes" class="form-control">
                    ...
                    @foreach($estudiantes as $estudiante)
                        <option value="{{ $estudiante->id }}"
                            {{ old('id_estudiantes') == $estudiante->id ? 'selected' : '' }}>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="codigo_materia" class="form-control" value="{{ old('codigo_materia') }}" required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="nombre_materia" class="form-control" value="{{ old('nombre_materia') }}" required>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <select name="grupo" class="form-control" required>
                    ...
                    <option value="C" {{ old('grupo') == 'C' ? 'selected' : '' }}>C</option>
                </select>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="docente" class="form-control" value="{{ old('docente') }}" required>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <select name="semestre" class="form-control" required>
                    ...
                    <option value="1-2025" {{ old('semestre') == '1-2025' ? 'selected' : '' }}>1-2025</option>
                    <option value="2-2025" {{ old('semestre') == '2-2025' ? 'selected' : '' }}>2-2025</option>
                </select>
            </div>
        </div>
